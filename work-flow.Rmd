...
This is the main document for my master thesis.
I wrote "eval=FALSE" so that it does not overwrite existing data. 
...
In the null model.
If it is not null model, I call it pseudo ICC. 
...
beta2= 0, 0.1, 0.3 or 0.5  (3 conditions in beta2)
...
as said earlier, 
keeping warning message might be worthy (just in case)
```{r, eval=FALSE}
...
includes mean of parameters, and other information such as AIC and criterion. 
```{r, eval=FALSE}
